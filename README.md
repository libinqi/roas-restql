...
roas-restql requires node v6.0.0 or higher for (partial) ES2015 support.

```sh
npm install --save roas-restql
```
...
[npm-url]: https://www.npmjs.com/package/roas-restql
